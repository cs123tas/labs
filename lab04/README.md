...
![installing maya](/images/install.png)
...
![manipulating camera view](/images/camera.png)
...
![manipulating sphere](/images/transformsphere.png)

![how to transform objects](/images/transforms.png)

Let’s add a cylinder. 

![cylinder added](/images/addcylinder.png)
...
![smoothing mesh hotkeys](/image/smoothmesh.png)

![cylinder w smoothing](/images/smoothcylinder.png)
...
![cylinder w edge loop](/images/cylinderedgeloop)
...
![selecting face for extrusion](/images/face.png)
...
![better-looking cylinder](/images/bettercylinder.png)
...
![cow imported into scene](/images/cowimport.png)
...
![dark scene](/images/darkscene.png)
...
![import stage](/images/stage.png)

To view our scene from the render camera: **Panels ➜ Perspective ➜ stage: render_cam**.

![some objects out of frame](/images/outofframe.png)
...
![where the light settings are](/images/lightsettings.png)
![high exposure](/images/highexposure.png)
![low exposure](/images/lowexposure.png)
...
![camera parameters adjusted](/images/cameraadjust.png)
...
![assigning materials to sphere](/images/assignmaterials1.png)
![assigning materials to sphere](/images/assignmaterials2.png)
![assigning materials to sphere](/images/assignmaterials3.png)
![rendered orange sphere](/images/orangesphere.png)
...
![shader for cow](/images/cowshader1.png)
![shader for cow](/images/cowshader2.png)
![rendered cow](/images/glasscow.png)
...
![align uv shells](/images/alignshells.png)

It should now look like this. 
![better looking texture](/images/bettermapping.png)
...
![making first keyframe](/images/firstkey.png)
...
![first 24 frames](/images/previewanim.png)
...
![preparing to render the sequence](/images/preparesequence.png)
...
![rendered animation as gif](/images/renderedanim.gif)
