    ...
    m_ui(new Ui::MainWindow)
{
    ...
    QGridLayout *gridLayoutVert = new QGridLayout(m_ui->vertCanvas);
    m_vertCanvas = new GLVertWidget(qglFormat, this, true);
    m_vertCanvas->setMinimumSize(50, 50);
    gridLayoutVert->addWidget(m_vertCanvas, 0, 1);

    // phong widget
    QGridLayout *gridLayout = new QGridLayout(m_ui->phongCanvas);
    ...
    QSettings qtSettings("CS123", "Lab06");
